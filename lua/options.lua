vim.g.python_host_prog = vim.fn.expand('~/.pyenv/versions/neovim-py3/bin/python')
vim.g.python3_host_prog = vim.fn.expand('~/.pyenv/versions/neovim-py3/bin/python3')
-- nodeの有効化
vim.g.node_host_prog = vim.fn.expand('~/.nodenv/shims/node')
-- rubyの有効化
